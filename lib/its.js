...
(function(){
	...
	for(; index < length; index++){
		(function(){
			...
			its[theType.toLowerCase()] = function(expression){
				return its.type.apply(null, [toString.call(expression) === '[object ' + theType + ']'].concat(slice.call(arguments, 1)));
			};
		}());
	}
}());
...
if (typeof (/./) !== 'function') {
	its.function = function(expression) {
...
var slice = Array.prototype.slice;// Reduce resolution calls
